...
export function KpiCard({ icon, label, value, unit, sub, theme = "teal", delay = 0 }) {
...
export function SelectField({ id, label, required, options, value, placeholder, onChange, disabled = false }) {
